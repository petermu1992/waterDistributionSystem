...
感谢各位观看我的B站视频-给水管网优化设计（管网模拟），并且基于我的代码进行修改使用。
...
——————————————————————————————————————————————————————————————————————————————————————————————————
English version:
Bilibili Video of water distribution system simulation：https://www.bilibili.com/video/BV1xb4y177qG?share_source=copy_web 
Thanks for viewing my video of water distribution system simulation in the bilibili website. Meanwhile, thanks for using and modifying my codes to publish.
